...
ytcfg.set({
    "EXPERIMENT_FLAGS": {
        ...
        "align_three_dot_menu_with_title_description": true,
        ...
        "enable_handle_watch_endpoint_click_for_vdc": true,
        "enable_handles_account_menu_switcher": true,
        "enable_live_overlay_feed_in_live_chat": true,
        ...
        "web_enable_sink_dislike_button_view_model": true,
        "web_enable_sink_like_button_view_model": true,
        "web_enable_sink_page_header_view_model": true,
        "web_enable_sink_segmented_like_dislike_button_view_model": true,
        "web_enable_sink_truncated_text": true,
        "web_enable_sink_yt_badge_view_model": true,
        "web_enable_sink_yt_content_metadata_view_model": true,
        "web_enable_sink_yt_flexible_actions_view_model": true,
        "web_enable_sink_yt_video_attribute_view_model": true,
        "web_forward_command_on_pbj": true,
        "web_gcf_hashes_innertube": true,
        "web_honor_cache_for_back": true,
        ...
        "web_slr_lazy_list_queue_warning_killswitch": true,
    ...
    "INNERTUBE_CLIENT_VERSION": "2.20250814.09.00",
    "INNERTUBE_CONTEXT": {
        "client": {
            "hl": "en-GB",
            "gl": "IN",
    ...
    "INNERTUBE_CONTEXT_CLIENT_VERSION": "2.20250814.09.00",
...
if (self.trustedTypes && self.trustedTypes.createPolicy) {
    var policy = self.trustedTypes.createPolicy('youtubeServiceWorkerPolicy', {
        createScriptURL: function(unused) {
            return 'https:\/\/www.youtube.com\/s\/desktop\/f717390d\/jsbin\/serviceworker-kevlar-appshell.vflset\/serviceworker-kevlar-appshell.js';
        }
    });
    importScripts(policy.createScriptURL(''));
} else {
    importScripts('https:\/\/www.youtube.com\/s\/desktop\/f717390d\/jsbin\/serviceworker-kevlar-appshell.vflset\/serviceworker-kevlar-appshell.js');
}