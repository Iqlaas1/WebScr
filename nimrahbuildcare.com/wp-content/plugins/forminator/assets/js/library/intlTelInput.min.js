...
(function(factory) {
    ...
    var factoryOutput = (() => {
        ...
        var R = (l, t) => {
            ...
            F = (l, t, e, i) => {
                if (t && typeof t == "object" || typeof t == "function")
                    for (let n of H(t)) !O.call(l, n) && n !== e && L(l, n, {
                        get: () => t[n],
        ...
        var K = 0,
            ...
            w = class {
                constructor(t, e = {}) {
                    this.id = K++, this.a = t, this.c = null, this.d = Object.assign({}, P, e), this.e = !!t.getAttribute("placeholder")
                }
                _init() {
                    ...
                    this.showSelectedCountryOnLeft = this.isRTL ? !t : t, this.d.separateDialCode && (this.isRTL ? this.originalPaddingRight = this.a.style.paddingRight : this.originalPaddingLeft = this.a.style.paddingLeft), this.d.i18n = { ...T,
                        ...this.d.i18n
                    };
                ...
                _f() {
                    ...
                    let {
                        ...
                        countrySearch: d,
                        i18n: c
                    } = this.d, m = "forminator-iti-input iti";
                    t && (m += " iti--allow-dropdown"), i && (m += " iti--show-flags"), n && (m += ` ${n}`), a || (m += " iti--inline-dropdown");
                    let h = p("div", {
                        class: m
                    });
                    if (this.a.parentNode ? .insertBefore(h, this.a), t || i || e) {
                        this.k = p("div", {
                            class: "iti__country-container"
                        }, h), this.showSelectedCountryOnLeft ? this.k.style.left = "0px" : this.k.style.right = "0px", t ? (this.selectedCountry = p("button", {
                            type: "button",
                            ...
                            role: "combobox"
                        }, this.k), this.a.disabled && this.selectedCountry.setAttribute("disabled", "true")) : this.selectedCountry = p("div", {
                            class: "iti__selected-country"
                        }, this.k);
                        let g = p("div", {
                        ...
                        if (this.l = p("div", {
                                class: "iti__flag"
                            }, g), this.selectedCountryA11yText = p("span", {
                                class: "iti__a11y-text"
                            }, this.l), t && (this.u = p("div", {
                                class: "iti__arrow",
                                "aria-hidden": "true"
                            }, g)), e && (this.t = p("div", {
                            ...
                            if (this.dropdownContent = p("div", {
                                    ...
                                    autocomplete: "off"
                                }, this.dropdownContent), this.searchResultsA11yText = p("span", {
                                    class: "iti__a11y-text"
                                }, this.dropdownContent)), this.countryList = p("ul", {
                                    class: "iti__country-list",
                                    id: `iti-${this.id}__country-listbox`,
                                    role: "listbox",
                                    "aria-label": c.countryListAriaLabel
                                }, this.dropdownContent), this._g(), d && this._p4(), o) {
                                let C = "forminator-iti-input iti iti--container";
                                a ? C += " iti--fullscreen-popup" : C += " iti--inline-dropdown", this.dropdown = p("div", {
                                    class: C
                                }), this.dropdown.appendChild(this.dropdownContent)
                            } else this.k.appendChild(this.dropdownContent)
                        }
                    }
                    if (h.appendChild(this.a), this._updateInputPadding(), s) {
                ...
                _i4() {
                    r.autoCountry ? this.handleAutoCountry() : r.startedLoadingAutoCountry || (r.startedLoadingAutoCountry = !0, typeof this.d.geoIpLookup == "function" && this.d.geoIpLookup((t = "") => {
                        let e = t.toLowerCase();
                        e && this._y(e, !0) ? (r.autoCountry = e, setTimeout(() => v("handleAutoCountry"))) : (this._h(!0), v("rejectAutoCountryPromise"))
                    }, () => {
                ...
                _j() {
                    ...
                    /\p{L}/u.test(this.a.value) && (u = !0), this._a12 = a => {
                        if (this.isAndroid && a ? .data === "+" && i && s && o) {
                            ...
                            this.a.value = g + y, this._nWithPlus();
                            return
                        }
                        ...
                        if (e && !u && !m) {
                            let h = this.a.selectionStart || 0,
                                ...
                                b = this._9(),
                                _ = V(y, b, h, C);
                            this.a.value = b, this.a.setSelectionRange(_, _)
                        }
                ...
                _p3(t, e = !1) {
                    ...
                    for (let s = 0; s < this.p.length; s++) {
                        ...
                        if (e || u.includes(n) || d.includes(n) || o.iso2.includes(n) || a.includes(n)) {
                            ...
                            c && this.countryList.appendChild(c), i && (this._x(c, !1), i = !1)
                        }
                    }
                ...
                _getCountryFromNumber(t) {
                    ...
                    if (o) {
                        let a = I(o),
                            d = this.q[a];
                        if (!n && this.j && d.includes(this.j)) return this.j;
            ...
            W = l => {
                if (!r.utils && !r.startedLoadingUtilsScript) {
                    ...
                    return r.startedLoadingUtilsScript = !0, t.then(e => {
                        ...
                        return r.utils = i, v("handleUtils"), !0
                    }).catch(e => {
                        throw v("rejectUtilsScriptPromise", e), e
                    })
                }
                return null
            },
