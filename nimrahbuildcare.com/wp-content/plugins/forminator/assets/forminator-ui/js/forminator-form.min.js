...
function(t) {
    ...
    "object" !== _typeof(window.FUI) && (window.FUI = {}), FUI.select = {}, FUI.select.escapeJS = function(e) {
        ...
        var o = FUI.select.escapeJS(t.text),
            i = t.selected,
            a = o.toLowerCase().replace(/\s+/g, "-");
        return t.id && (a = t.id), '<label for="' + a + '" class="forminator-checkbox"><input type="checkbox" value="' + o + '" id="' + a + '" ' + (i ? "checked" : "") + ' /><span class="forminator-checkbox-box" aria-hidden="true"></span><span class="forminator-select-label">' + o + "</span></label>"
        ...
        t(".forminator-custom-form").each(function() {
            ...
            t.each(["bold", "flat", "default", "basic", "material", "none"], function(a, r) {
                ...
                e.hasClass("forminator-design--" + r) && i.length && i.each(function() {
                    ...
                    n = !0 === e.data("rtl-support") ? "rtl" : "ltr", l = e.data("placeholder") ? e.data("placeholder") : "Select", s = e.data("language") ? e.data("language") : "en", d = !0 === e.data("search") ? 0 : -1, !0 === e.data("checkbox") ? (c = !0, f += " forminator-dropdown--checkbox") : c = !1, e.prop("multiple") && (f += " forminator-dropdown--multiple"), a.length || (a = t(document.body)), e.FUIselect2(_objectSpread({
                        dir: n,
                        language: s,
                        placeholder: l,
                        dropdownCssClass: f,
