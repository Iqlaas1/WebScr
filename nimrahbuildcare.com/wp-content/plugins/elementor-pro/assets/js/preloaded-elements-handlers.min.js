...
(self.webpackChunkelementor_pro = self.webpackChunkelementor_pro || []).push([
    [995, 26, 534, 369, 804, 888, 680, 121, 288, 42, 50, 985, 287, 824, 58, 114, 443, 838, 685, 858, 102, 1, 124, 859, 979, 497, 800, 149], {
        9978: (e, t, s) => {
            var n = s(3203),
                i = n(s(5574)),
                o = n(s(9743)),
        ...
        5030: (e, t, s) => {
            ...
            Object.defineProperty(t, "__esModule", {
                value: !0
            }), t.createElement = createElement, t.default = function addDocumentHandle(e) {
                let {
                    element: t,
                    id: s,
                    title: i = n("Template", "elementor-pro")
                } = e, r = arguments.length > 1 && void 0 !== arguments[1] ? arguments[1] : o, a = arguments.length > 2 && void 0 !== arguments[2] ? arguments[2] : null;
                if (o === r) {
                    if (!s || !t) throw Error("`id` and `element` are required.");
                    if (isCurrentlyEditing(t) || hasHandle(t)) return
                }
                const l = createHandleElement({
                    title: i,
                    onClick: () => onDocumentClick(s, r, a)
                }, r);
                t.prepend(l), o === r && (t.dataset.editableElementorDocument = s)
            };
            ...
            function createHandleElement(e, t) {
                ...
                const l = createElement({
                    ...
                    children: [createElement({
                        ...
                        children: [document.createTextNode(o === t ? n("Edit %s", "elementor-pro").replace("%s", s) : n("Save %s", "elementor-pro").replace("%s", s))]
                    })]
                });
            ...
            function getHandleIcon(e) {
                let t = "eicon-edit";
                return "save" === e && (t = elementorFrontend.config.is_rtl ? "eicon-arrow-right" : "eicon-arrow-left"), t
            }
            ...
            function createElement(e) {
                ...
                return i.classList.add(...s), n.forEach((e => i.appendChild(e))), i
            }
        ...
        4098: (e, t, s) => {
            ...
            class LoopLoadMore extends i.default {
                ...
                afterInsertPosts(e) {
                    super.afterInsertPosts(e), this.runElementHandlers(e)
                }
        ...
        9491: (e, t, s) => {
            ...
            var o = i(s(2298)),
                r = i(s(5030));
            class LoopGrid extends o.default {
                getSkinPrefix() {
                    return ""
                }
                getDefaultSettings() {
                ...
                attachEditDocumentHandle() {
                    ...
                    e && t && (0, r.default)({
                        element: e,
                        title: n("Template", "elementor-pro"),
                        id: t
                ...
                handleCTA() {
                    ...
                    t.appendChild(elementorPro.modules.loopBuilder.getCtaStyles()), t.appendChild(elementorPro.modules.loopBuilder.getCtaContent());
            ...
            t.default = class TimesUtils {
                ...
                setExpiration(e, t, s) {
                    if (this.storage.get(e)) this.storage.set(e, t);
                        ...
                        const n = {
                            lifetimeInSeconds: this.getTimeFramesInSecounds(s)
                        };
            ...
            class LoadMore extends elementorModules.frontend.handlers.Base {
                ...
                handleSuccessFetch(e) {
                    ...
                    const t = this.getSettings("selectors"),
                        ...
                        n = e.querySelector(".e-load-more-anchor").getAttribute("data-next-page");
                    s.forEach((e => this.elements.postsContainer.append(e))), this.elements.loadMoreAnchor.setAttribute("data-page", this.currentPage), this.elements.loadMoreAnchor.setAttribute("data-next-page", n), this.currentPage === this.maxPage && this.handleUiWhenNoPosts(), this.afterInsertPosts(s)
                }
                handlePostsQuery() {
                ...
                o = i.default.extend({
                    ...
                    arrangeGrid() {
                        var e = jQuery,
                            ...
                            o = n.filter(":hidden"),
                            r = i.filter(":visible");
                        if (t.elements.$posts.css("transition-duration", s.transitionDuration + "ms"), t.showItems(o), t.isEdit && t.fitImages(), t.handleEmptyColumns(), t.isMasonryEnabled()) return t.hideItems(r), t.showItems(o), t.handleEmptyColumns(), void t.runMasonry();
                        r.css({
                            opacity: 0,
                        ...
                        d.each((function() {
                            var s = e(this),
                                n = t.getOffset(l.index(s), c, m),
                                i = t.getOffset(a.index(s), c, m);
            ...
            class SlidesHandler extends elementorModules.frontend.handlers.SwiperBase {
                ...
                async initSlider() {
                    ...
                    const s = this.getSettings(),
                        n = e.data(s.attributes.dataAnimation);
                    n && (this.swiper.on("slideChangeTransitionStart", (function() {
                        e.find(s.selectors.slideInnerContents).removeClass(s.classes.animated + " " + n).hide()
                    })), this.swiper.on("slideChangeTransitionEnd", (function() {
                        e.find(s.selectors.slideInnerContents).show().addClass(s.classes.animated + " " + n)
                    })))
                }
                onInit() {
        ...
        8208: (e, t, s) => {
            ...
            class TOCHandler extends elementorModules.frontend.handlers.Base {
                ...
                handleNoHeadingsFound() {
                    const e = n("No headings were found on this page.", "elementor-pro");
                ...
                collapseBodyListener() {
                    const e = elementorFrontend.breakpoints.getActiveBreakpointsList({
                        ...
                        n = this.$element.hasClass(this.getSettings("classes.collapsed"));
                    "desktop" === t || e.indexOf(t) >= e.indexOf(s) ? n || this.collapseBox() : n && this.expandBox()
                }
                onElementChange(e) {
        ...
        915: (e, t) => {
            ...
            class Base extends elementorModules.frontend.handlers.Base {
                ...
                updateWpReferers() {
                    ...
                    s.searchParams.set("elementorPageId", elementorFrontend.config.post.id), s.searchParams.set("elementorWidgetId", this.getID()), t.attr("value", s)
                }
            }
            t.default = Base
        },
        ...
        2083: (e, t) => {
            ...
            class _default extends elementorModules.frontend.handlers.Base {
                ...
                bindEvents() {
                    ...
                    if (n && i) return void this.$element.find(o.toggleButton).attr("href", s);
                ...
                governDropdownHeight() {
                    ...
                    const e = this.getSettings("selectors"),
                        ...
                        s = this.$element.find(e.toggle);
                    if (!t.length || !s.length) return;
                    this.$element.find(e.productList).css("max-height", "");
                    const n = document.documentElement.clientHeight,
                        i = s.height() + parseInt(this.elements.$main.css("margin-top")),
                        o = s[0].getBoundingClientRect().top,
                        r = t.height(),
                        a = n - o - i - (this.elements.$main.prop("scrollHeight") - r) - 30,
                        l = Math.max(120, a);
                    t.css("max-height", l)
                }
            }
        ...
        5767: (e, t, s) => {
            ...
            class ProductAddToCart extends i.default {
                ...
                handleAddedToCart(e) {
                    const t = this.getSettings("selectors"),
                        s = e.siblings(t.addedToCartButton),
                        n = s.parents(t.loopFormContainer);
                    n.children(t.addedToCartButton).remove(), n.append(s)
                }
                bindEvents() {
                    super.bindEvents(...arguments), this.elements.$quantityInput.on("change", (() => {
                        this.updateAddToCartButtonQuantity()
                    })), elementorFrontend.elements.$body.off("added_to_cart.elementor-woocommerce-product-add-to-cart"), elementorFrontend.elements.$body.on("added_to_cart.elementor-woocommerce-product-add-to-cart", ((e, t, s, n) => {
                        this.handleAddedToCart(n)
                    }))
                }
            }
