    ...
    return {
            ...
            if (document.getElementById("siqiframe")) S.className = S.className.replace(/(?:^|\s)siq_showload(?!\S)/, "");
                ...
                !window._IS_DEV && function() {
                    ...
                    if (iscdnenabled && !$ZSIQChat.isPreview()) {
                        var t = $zohosq.nonce,
                            i = {};
                        i[SIQ_FLOAT] = "/salesiq/styles/floatbuttonpostload_S5HNJwau1PlMkc18a6InKleG3V-M1srNOiYisVaC3wqeJ7BJWxpuIqc1E9mPchsP_.css", i[SIQ_BUTTON] = "/salesiq/styles/buttonthemepostload_yUis0sioMxe1rx7Qd3xIO1zJu-3X4_Cs8aWQiwYxagCuZXpbFY2-HyoQiJc9yy9__.css", i[SIQ_PERSONALIZE] = "/salesiq/styles/personalizethemepostload_5IE0VkDCP4DXr3gA5Deng8sq-3w4CAn9HWGGXr2hhSdzwOHX91VjKdxqaB2JurZd_.css";
                        var a = e.widgetobj,
                            ...
                            d = n.split("WIDGTHEME"),
                            c = d.join(s),
                            I = window.cssjslist[n.split("_")[0].substr(8) + ".css"];
                        l = void 0 !== cssjslist[c] ? r + (n = "/salesiq" + d[0] + s + "_" + cssjslist[c] + "_" + d[1]) : r + n;
                        var g = document.createElement("link");
                        g.rel = "stylesheet", g.href = l, g = $ZSIQUtil.setIntegrityAttr(g, I);
                        var m = document.getElementsByTagName("head");
                        $ZSIQChat.notifyOnCDNFailure(g, m, (o + i[e.widgettype]).replace(/WIDGTHEME/g, s), "css"), t && g.setAttribute("nonce", t), m[0].appendChild(g)
                    }
        ...
        getRevampWindowVariables: function(e, t) {
            var i, a = e.einfo,
                ...
                o = {
                    ...
                    commonStaticUrl: s.commonstaticurl,
        ...
        getFiles: function() {
            ...
            if (window._IS_REVAMP) {
                ...
                }), [this.getRevampWindowVariables(t, e, i)].concat(this.getStaticFileNodes(a[0], "js")).concat(this.getStaticFileNodes(a[1], "js", !0)).concat(this.getStaticFileNodes(a[2], "css")).concat(this.getStaticFileNodes(a[3], "css"))
            }
            ...
            if (iscdnenabled && (i.cssstaticfile = "/salesiq/styles/embedtheme" + t.theme + "_" + cssjslist[i.cssstaticfile] + "_.css", i.jsstaticfile = "/salesiq/js/siqchatwindow" + t.theme + "_" + cssjslist[i.jsstaticfile] + "_.js"), $ZSIQChatWindow.isNewHeader()) {
                ...
                i.cssstaticfile = t.isRtlLang ? "/salesiq/styles/embedrtl_WGZ6o1LPNUEQrUl3ySDyoSb76Ocu8GdK3X5I3oRG1oXRXMe-_ARsN66Xnykxtsda_.css" : "/salesiq/styles/newembedtheme_7nMmFo0ESIxWpUGdpIA_Gji1F1wXJfgzxXqzov8GXJfF87FZxcjEP__h96HoqdCb_.css", i.jsstaticfile = g ? "/salesiq/js/siqnewchatwindow1_zO0fA98jZWbtubQ5DlhhDEygHuFNKZN0iwv9o8Lf1AMlu0v5ZUyKHBrUC0y_hhO2_.js" : "/salesiq/js/siqnewchatwindow_FIKResNKfw5uVS-4uBACBxIGK4btMx7cofC9U1dpWXTOp1_HQJ1Ds5B_z_7lE7g8_.js"
            }
            ...
            if (t.ucomp) {
                var u = $zohosq.nonce ? 'nonce ="' + $zohosq.nonce + '"' : "",
                    p = n.jscdnstaticserver + "/salesiq/js/embedmedia-rtc_iZxukxgw2SVK7YWK9QB_hjWq7DytR9Doc_x1mcZv1d6c1yPIDykxeoJ0TxkOm0tP_.js";
...
var $ZSIQWidgetUI = $ZSIQWidgetUI || function() {
    ...
    return {
        ...
        bindDragEvent: function() {
            var s, l, n = g,
                e = n.querySelector("img"),
                o = !1,
                d = window.innerHeight - n.clientHeight,
                r = window.innerWidth - n.clientWidth,
                i = "siq_widget_position";

            function c(e, t) {
                $ZSIQLSDB.storeInSession(i, {
                    top: t,
                    left: e
                }), n.style.left = e, n.style.top = t
            }

            function t(e) {
                var t, i;
                e.preventDefault(), "touchmove" === e.type ? (t = e.touches[0].clientX - s, i = e.touches[0].clientY - l, o = !0) : (t = e.clientX - s, i = e.clientY - l);
                var n = 0,
                    a = document.getElementById("titlediv");
                a && (n = -a.offsetLeft), c((t = Math.min(Math.max(t, 0 + n), r)) + "px", (i = Math.min(Math.max(i, 0), d)) + "px")
            }

            function a() {
                n.classList.remove("siq_noanim");
                var e = document.getElementById("ghostimage");
                e && document.body.removeChild(e)
            }
            n.setAttribute("draggable", !0), e && e.setAttribute("draggable", !1);
            var I = $ZSIQLSDB.getFromSession(i);
            I && c(I.left, I.top), n.addEventListener("dragstart", function(e) {
                var t = document.createElement("div");
                t.id = "ghostimage", t.setAttribute("style", "position: absolute;height:40px; width: 40px;z-index: -1; opacity:0"), document.body.appendChild(t), e.dataTransfer.setDragImage(t, 0, 0);
                var i = n.getBoundingClientRect();
                s = e.clientX - i.left, l = e.clientY - i.top, n.classList.add("siq_noanim")
            }), document.addEventListener("dragover", t), n.addEventListener("dragend", a), n.addEventListener("touchmove", t), n.addEventListener("touchstart", function(e) {
                e.preventDefault(), o = !1;
                var t = n.getBoundingClientRect();
                s = e.touches[0].clientX - t.left, l = e.touches[0].clientY - t.top, setTimeout(function() {
                    !o && n.click()
                }, 200)
